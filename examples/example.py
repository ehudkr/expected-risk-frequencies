# Code for generating the charts in the README file
...
print(result)
print(result.text)
alt_save(result.chart, "examples/isotype_grid.png",
         method='selenium', webdriver=webdriver)


# # Example README, plot parameters:
# baseline_risk = 10.2 / 100
# odds_ratio = 5.21
...
# )
# alt_save(chart, "examples/isotype_grid_2.png",
#          method='selenium', webdriver=webdriver)


# Example README multi-panel chart:
data = pd.DataFrame({
...
chart = plot_expected_frequencies(
    ...
    stroke_width=2.5, chart_width=500, chart_height=500,
).properties(
    title={"text": "Cat icon: Raúl Inc, CC0, via Wikimedia Commons",
           "fontSize": 12,
           "fontWeight": 200,
           "anchor": "end",
           "dy": 550}
)
alt_save(chart, "examples/cat_chart.png",
         method='selenium', webdriver=webdriver)
